    ...
    match header.command.cmd_type {
        ...
        CommandType::SREQ => {
            match header.command.id {
                ...
                0x07 => Ok(MAC_DisassociateReq_SREQ(sreq::DisassociateReq::try_from(cursor)?)),
                0x08 => Ok(MAC_GetReq_SREQ(sreq::GetReq::try_from(cursor)?)),
                0x09 => Ok(MAC_SetReq_SREQ(sreq::SetReq::try_from(cursor)?)),
                0x30 => Ok(MAC_SecurityGetReq_SREQ(sreq::SecurityGetReq::try_from(cursor)?)),
                0x31 => Ok(MAC_SecuritySetReq_SREQ(sreq::SecuritySetReq::try_from(cursor)?)),
                0x32 => Ok(MAC_UpdatePANIdReq_SREQ(sreq::UpdatePANIdReq::try_from(cursor)?)),
                0x33 => Ok(MAC_AddDeviceReq_SREQ(sreq::AddDeviceReq::try_from(cursor)?)),
                0x34 => Ok(MAC_DeleteDeviceReq_SREQ(sreq::DeleteDeviceReq::try_from(cursor)?)),
                0x35 => Ok(MAC_DeleteAllDevicesReq_SREQ(sreq::DeleteAllDevicesReq::try_from(cursor)?)),
        ...
        CommandType::AREQ => {
            match header.command.id {
                ...
                0x83 => Ok(MAC_BeaconNotifyInd_AREQ(areq::BeaconNotifyInd::try_from(cursor)?)),
                0x86 => Ok(MAC_DisassociateInd_AREQ(areq::DisassociateInd::try_from(cursor)?)),
                0x87 => Ok(MAC_DisassociateCnf_AREQ(areq::DisassociateCnf::try_from(cursor)?)),
                ...
                0x8d => Ok(MAC_CommStatusInd_AREQ(areq::CommStatusInd::try_from(cursor)?)),
        ...
        CommandType::SRSP => {
            match header.command.id {
                ...
                0x07 => Ok(MAC_DisassociateReq_SRSP(srsp::DisassociateReq::try_from(cursor)?)),
                0x08 => Ok(MAC_GetReq_SRSP(srsp::GetReq::try_from(cursor)?)),
                0x09 => Ok(MAC_SetReq_SRSP(srsp::SetReq::try_from(cursor)?)),
                0x30 => Ok(MAC_SecurityGetReq_SRSP(srsp::SecurityGetReq::try_from(cursor)?)),
                0x31 => Ok(MAC_SecuritySetReq_SRSP(srsp::SecuritySetReq::try_from(cursor)?)),
                0x32 => Ok(MAC_UpdatePANIdReq_SRSP(srsp::UpdatePANIdReq::try_from(cursor)?)),
                0x33 => Ok(MAC_AddDeviceReq_SRSP(srsp::AddDeviceReq::try_from(cursor)?)),
                0x34 => Ok(MAC_DeleteDeviceReq_SRSP(srsp::DeleteDeviceReq::try_from(cursor)?)),
                0x35 => Ok(MAC_DeleteAllDevicesReq_SRSP(srsp::DeleteAllDevicesReq::try_from(cursor)?)),
